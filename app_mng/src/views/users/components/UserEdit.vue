    ...
    <el-form ref="postForm" :model="postForm" label-width="120px">
      ...
      <el-form-item label="Roles" prop="roles">
        <el-checkbox-group v-model="postForm.roles">
          ...
          <el-checkbox label="manager" name="roles">Manager</el-checkbox>
          <el-checkbox label="team-leader" name="roles">Team Leader</el-checkbox>
          <el-checkbox label="loader" name="roles">Loader</el-checkbox>
        </el-checkbox-group>
      </el-form-item>
      <el-form-item>
